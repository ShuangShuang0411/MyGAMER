...
static double Blast_Pres_Exp_2;      // explosion pressure_2
static double Blast_Radius;        // explosion radius
static double Blast_Center[3];     // explosion center
static double Blast_Center_2[3];     // explosion center_2
#ifdef MHD
...
// ********************************************************************************************************************************
   ...
   ReadPara->Add( "Blast_Pres_Exp_2",    &Blast_Pres_Exp_2,        -1.0,          Eps_double,       NoMax_double      );
   ...
   ReadPara->Add( "Blast_Center_X_2",    &Blast_Center_2[0],       -1.0,          NoMin_double,     amr->BoxSize[0]   );
   ReadPara->Add( "Blast_Center_Y_2",    &Blast_Center_2[1],       -1.0,          NoMin_double,     amr->BoxSize[1]   );
   ReadPara->Add( "Blast_Center_Z_2",    &Blast_Center_2[2],       -1.0,          NoMin_double,     amr->BoxSize[2]   );
#  ifdef MHD
...
// set the default explosion center
   ...
   Blast_Center[0] = 0.8*amr->BoxSize[0];

   for (int i=1; i<3; i++)
      if ( Blast_Center_2[i] < 0.0 )  Blast_Center_2[i] = 0.5*amr->BoxSize[i];
   Blast_Center_2[0] = 0.2*amr->BoxSize[0];
                ...
                const int lv, double AuxArray[] )
{
   ...
   MomY = 0.0;
   MomZ = 0.0;
   Pres = ( r <= Blast_Radius || r_2 <= Blast_Radius ) ? Blast_Pres_Exp : Blast_Pres_Bg;
